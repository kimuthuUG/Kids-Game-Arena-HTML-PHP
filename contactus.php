	...
	<header id="top_header" class="gamearena">
		...
		<div class="wrapper">
			...
			<nav id="main_nav">
				...
				<a href="#" style="color:#73e298;">Contact Us</a>
			</nav>
		</div>
	</header>
	...
	<section id="banner" class="gamearena">
		...
		<div class="contact-box">
			...
			<div class="right">
				...
				<input disabled type="text" name="name" class="field" placeholder="<?php echo $_SESSION['user_name'] ?>">
				<input type="email" name="email" class="field" placeholder="Your Email">
				<textarea name="message" placeholder="Why are you trying to contact us" class="field"></textarea>
