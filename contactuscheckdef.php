...
<body>
	<header id="top_header" class="gamearena">
		...
		<div class="wrapper">
			...
			<a class="navbar-brand" href="#">
				...
				<a href="index.html"><img src="images/logo.png" alt="Logo" title="Kids Game Arena" style="height:35px;"/></a>
				<div class="use">
                <div class="action">
                        ...
                        <div class="menu">
                            ...
                            <h5>Welcome<br><span></h5><h4>Let's Play!</span></h4>
			...
			<nav id="main_nav">
				...
				<a href="contactus.html" style="color:#73e298;">Contact Us</a>
			</nav>
		</div>
	</header>
	...
	<section id="banner" class="gamearena">
		...
		<div class="contact-box">
			...
			<div class="right">
				<h2>Contact Us</h2>
				<form method="post" action="contactuscheckdef.php">
