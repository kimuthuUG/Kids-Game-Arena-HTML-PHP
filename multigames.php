...
<html>
<head>
	<title>Kids Game Arena - Multiplayer Games</title>
	...
	<header id="top_header" class="gamearena">
		...
		<div class="wrapper">
			...
			<nav id="main_nav">
				...
				<a href="#" style="color:#73e298;">Multiplayer Games</a>
...
<section id="games-barsecond" class="gamearena">
		<div class="wrapper">
			<header class="gamearena">
				<h2>Multiplayer Games</h2> <i class='fa fa-dice' style='font-size:24px'></i>
