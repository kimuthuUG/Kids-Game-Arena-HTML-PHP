...
<html>
<head>
	<title>Kids Game Arena | Sign Up - Admin</title>
...
<body>
                ...
                <div class="action">
                        ...
                        <div class="menu">
                            ...
                            <ul>
								...
								<li><img src="images/register.png"><a href="registeruser.php">User Sign Up</a></li>
   ...
   <form action="" method="post">
   	<img src="images/useravataradmin.png" alt="Logo" title="Kids Game Arena" style="height:175px;"/>
      <h3>Admin Register <i class="fa fa-gear fa-spin" style="font-size:15px; color:#2a2a2e"></i></h3>
      <?php
      if(isset($error)){
